...
Page({
    ...
    wx.getSystemInfo({
      success: function (res) {
        ...
        getApp().getAreaData(function (data) {
          areaInfo = data
          that.setData({
            areaList: toolUtils.areaPickerData(data, [
              [],
              [],
              []
            ], 0, 0)
  ...
  bindViewPicker: function (e) {
    ...
    if ("cancel" == e.detail.id) {


    } else if ("confirm" == e.detail.id) {
      if (tag == 1) {
...
function groupDetail() {
  httpsUtils.groupDetail(mGroupId, {}, function (res) {
    ...
    mVenuesName = res.group_venues_name
