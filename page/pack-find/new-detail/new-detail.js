...
Page({
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: '/page/pack-find/new-detail/new-detail?isShare=1&news_id=' + that.data.newsID,
      success: function (res) {
        // 转发成功
        var params = {}
        params.share_type = 1
        params.branch_id = that.data.newsID
        httpUtils.putShare(params, function (res) {
...
function getData(id) {
  var params = {}
  httpUtils.newsDetails(id, params, function (res) {
    that.setData({
